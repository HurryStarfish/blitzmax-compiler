-- https://github.com/mfrigerio17/lua-template-engine (replaced load in line 22 with loadstring and setfenv)
...
local function eval_sandbox(unsafe_code, env)
  ...
  local unsafe_fun, msg = loadstring(unsafe_code, nil, 't', env)
  setfenv(unsafe_fun, env)
